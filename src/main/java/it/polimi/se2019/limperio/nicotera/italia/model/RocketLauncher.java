...
public class RocketLauncher extends  WeaponCard{
    ...
    public RocketLauncher() {
        ...
        String description;
        description = "BASIC EFFECT: Deal 2 damage to 1 target you can see that is not on your square.\n Then you may move the target 1 square." +
                      "WITH ROCKET JUMP: Move 1 or 2 squares. This effect can be used either before or after the basic effect." +
                      "WITH FRAGMENTIN WARHED: During the basic effect, deal 1 damage to every player on your target's original square – including the target, even if you move it." +
