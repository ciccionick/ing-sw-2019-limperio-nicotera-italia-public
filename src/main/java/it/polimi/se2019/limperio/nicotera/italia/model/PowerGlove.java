...
public class PowerGlove extends WeaponCard {
    ...
    public PowerGlove() {
        ...
        getDescriptionsOfAttack().add("hoose 1 target on any square exactly 1 move away. Move onto that square and give the target 1 damage and 2 marks");
        getDescriptionsOfAttack().add("");
        getDescriptionsOfAttack().add("");
        getDescriptionsOfAttack().add("Choose a square exactly 1 move away. Move onto that square. You may deal 2 damage to 1 target there. \nIf you want, you may move 1 more square in that same direction (but only if it is a legal move). You may deal 2 damage to 1 target there, as well");
