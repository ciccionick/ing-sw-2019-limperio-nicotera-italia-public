...
public class TestMapFourthType {
    private Map map;
    @Before
    ...
    public void TestMapType4 () {
        ...
        Assert.assertTrue(map.getMatrixOfSquares()[0][1].isHasDoor());
        ...
        Assert.assertEquals(map.getMatrixOfSquares()[1][2].getColor(), ColorOfFigure_Square.PURPLE);
        ...
        testSetAdjForFourthType();
    }

    private void testSetAdjForFourthType(){
        map.setAdjForFourthType();
        ...
        Assert.assertTrue(map.getMatrixOfSquares()[0][0].getEast().isHasDoor());
        Assert.assertFalse(map.getMatrixOfSquares()[0][0].getEast().isSpawn());
        assertNull(map.getMatrixOfSquares()[0][1].getNorth());
        assertEquals(map.getMatrixOfSquares()[0][1].getSouth().getColor(), ColorOfFigure_Square.PURPLE);
        Assert.assertTrue(map.getMatrixOfSquares()[0][1].getSouth().isHasDoor());
        Assert.assertFalse(map.getMatrixOfSquares()[0][1].getSouth().isSpawn());
        assertEquals(map.getMatrixOfSquares()[0][1].getWest().getColor(), ColorOfFigure_Square.RED);
        ...
        assertEquals(map.getMatrixOfSquares()[0][2].getSouth().getColor(), ColorOfFigure_Square.PURPLE);
        ...
        Assert.assertTrue(map.getMatrixOfSquares()[0][2].getWest().isHasDoor());
        Assert.assertFalse(map.getMatrixOfSquares()[0][2].getWest().isSpawn());
        assertNull(map.getMatrixOfSquares()[0][2].getEast());
        assertEquals(map.getMatrixOfSquares()[1][0].getNorth().getColor(), ColorOfFigure_Square.RED);
        ...
        assertEquals(map.getMatrixOfSquares()[1][0].getSouth().getColor(), ColorOfFigure_Square.GREY);
        Assert.assertTrue(map.getMatrixOfSquares()[1][0].getSouth().isHasDoor());
        Assert.assertFalse(map.getMatrixOfSquares()[1][0].getSouth().isSpawn());
        assertNull(map.getMatrixOfSquares()[1][0].getWest());
        assertNull(map.getMatrixOfSquares()[1][0].getEast());
        assertEquals(map.getMatrixOfSquares()[1][1].getNorth().getColor(), ColorOfFigure_Square.BLUE);
        Assert.assertTrue(map.getMatrixOfSquares()[1][1].getNorth().isHasDoor());
        Assert.assertFalse(map.getMatrixOfSquares()[1][1].getNorth().isSpawn());
        ...
        assertNull(map.getMatrixOfSquares()[1][1].getWest());
        assertEquals(map.getMatrixOfSquares()[1][1].getEast().getColor(), ColorOfFigure_Square.PURPLE);
        ...
        assertEquals(map.getMatrixOfSquares()[1][3].getWest().getColor(), ColorOfFigure_Square.PURPLE);
        ...
        assertEquals(map.getMatrixOfSquares()[2][0].getNorth().getColor(), ColorOfFigure_Square.RED);
        Assert.assertTrue(map.getMatrixOfSquares()[2][0].getNorth().isHasDoor());
        Assert.assertTrue(map.getMatrixOfSquares()[2][0].getNorth().isSpawn());
        assertNull(map.getMatrixOfSquares()[2][0].getSouth());
        assertNull(map.getMatrixOfSquares()[2][0].getWest());
        assertEquals(map.getMatrixOfSquares()[2][0].getEast().getColor(), ColorOfFigure_Square.GREY);
        Assert.assertTrue(map.getMatrixOfSquares()[2][0].getEast().isHasDoor());
        Assert.assertFalse(map.getMatrixOfSquares()[2][0].getEast().isSpawn());
        assertEquals(map.getMatrixOfSquares()[2][1].getNorth().getColor(), ColorOfFigure_Square.PURPLE);
        Assert.assertTrue(map.getMatrixOfSquares()[2][1].getNorth().isHasDoor());
        Assert.assertFalse(map.getMatrixOfSquares()[2][1].getNorth().isSpawn());
        assertNull(map.getMatrixOfSquares()[2][1].getSouth());
        assertEquals(map.getMatrixOfSquares()[2][1].getWest().getColor(), ColorOfFigure_Square.GREY);
        Assert.assertTrue(map.getMatrixOfSquares()[2][1].getWest().isHasDoor());
        Assert.assertFalse(map.getMatrixOfSquares()[2][1].getWest().isSpawn());
