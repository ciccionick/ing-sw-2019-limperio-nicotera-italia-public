...
public class TestMapThirdType {
    ...
    public void testMapType3(){
        ...
        assertFalse(map.getMatrixOfSquares()[0][1].isHasDoor());
     ...
     private void testSetAdjForThirdType(){
        ...
        Assert.assertFalse(map.getMatrixOfSquares()[1][1].getNorth().isHasDoor());
        ...
        assertEquals(map.getMatrixOfSquares()[2][1].getSouth().getColor(), ColorOfFigure_Square.PURPLE);
