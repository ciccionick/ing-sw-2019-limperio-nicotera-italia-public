...
public class TestMapThirdType {
    ...
    public void testMapType3(){
        ...
        assertTrue(map.getMatrixOfSquares()[0][1].isHasDoor());
        ...
        testSetAdjForThirdType();
    }

     private void testSetAdjForThirdType(){
        map.setAdjForThirdType();
        ...
        assertNull(map.getMatrixOfSquares()[1][1].getEast());
